...
import ContactGif from 'src/components/general/assets/video/gif/contact.gif'
  ...
  <div className="tw-relative tw-w-full tw-h-fit tw-bg-[#4AA4FF] tw-text-white  tw-flex-shrink-0">
    <div className="tw-flex tw-w-full tw-gap-6 tw-h-full tw-pb-36 tw-pt-10 tw-z-10">
      <div className="tw-flex tw-relative tw-flex-col tw-gap-12 tw-w-full tw-items-start tw-justify-center tw-px-24 tw-pt-24 max-sm:tw-px-4 max-md:tw-pt-4">
        ...
        <div className="tw-flex tw-h-fit tw-items-start tw-justify-center tw-text-2xl tw-gap-14 tw-font-light tw-w-full max-md:tw-flex-col tw-pb-24">
          <div className="tw-relative tw-flex tw-flex-col tw-w-1/2 tw-text-base max-md:tw-w-full max-md:tw-gap-4 tw-pb-12">
            ...
            <p>{`If you would like to reach out to our team for a general inquiry, please fill out the form.`}</p>
                     <div className="tw-relative tw-flex tw-h-fit tw-w-full tw-items-center tw-justify-center">
  <Image loading="eager" src={ContactGif} alt="" className="tw-h-fit tw-w-[300px] tw-absolute max-md:tw-top-[-120px] tw-top-0"></Image>
                     </div>
