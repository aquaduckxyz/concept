...
export const Landing = () =>{
  ...
  <div className="tw-relative tw-w-full tw-h-screen tw-max-w-[1300px] tw-max-h-[1000px] tw-px-12 tw-pb-12 tw-overflow-hidden tw-flex-shrink-0 max-md:tw-px-1">
    ...
    <div className="tw-relative tw-flex tw-w-full tw-flex-col tw-items-end max-md:tw-items-center  max-md:tw-pb-4 tw-justify-end tw-gap-6 tw-h-full tw-pb-24 tw-px-8">
      <div className="tw-flex tw-flex-col tw-gap-4 tw-items-end tw-justify-center tw-pb-12">
        <div className="tw-flex tw-h-fit tw-gap-6 tw-text-white tw-drop-shadow tw-font-semibold tw-text-2xl">
      ...
      <div
        className="tw-w-[200px] tw-h-[60px] tw-rounded-lg tw-border-[3px] tw-border-white tw-overflow-hidden tw-absolute tw-left-0 tw-bottom-0 tw-flex tw-justify-center tw-items-center max-md:tw-relative"
